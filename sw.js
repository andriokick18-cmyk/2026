...
//
const CACHE_NAME = "h2bapply-2026-v36"; // v36: v174 — aba "Planilhas & Robôs" no painel admin (alimentação automática das planilhas: coleta DOL, enriquecimento, frescor, vagas novas H-2A, planilhas do mês).
