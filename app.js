...
function mkDetailHTML(j){
  ...
  return`<div class="jd-content">
    ...
    <div class="info-grid">
      ...
      ${j.hasEmail&&j.emailBloqueado?`<div class="info-box" style="grid-column:1/-1;border-color:var(--amberb);background:var(--amberl)"><div class="info-lbl">📧 Email</div><div class="info-val" style="font-size:12px;color:#92400e;font-weight:700;cursor:pointer" onclick="sv('plans')">🔒 ${esc(t('email_locked'))}</div></div>`
